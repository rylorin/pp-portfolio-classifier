...
const options = {
    ...
    isArray: (name: string, jpath: string, isLeafNode: boolean, isAttribute: boolean) => {
        ...
        const arrayTags = ['securities.security', 'taxonomies.taxonomy', 'assignments.assignment', 'children.classification'];
...
export class XMLHandler {
    ...
    assignSecurityToTaxonomy(taxonomyName: string, path: string[], securityUuid: string, weight: number) {
        ...
        const existingAssignmentIndex = targetNode.assignments.assignment.findIndex((a: any) => 
            a.investmentVehicle && a.investmentVehicle["@_reference"] === securityRef
        );
