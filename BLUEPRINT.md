...
5. [ ] Logique de Classification (Mapping des données API vers la structure XML)
6. [ ] Gestion des "Titres vifs" (Stocks) vs Fonds
7. [ ] Support des taxonomies à profondeur variable
